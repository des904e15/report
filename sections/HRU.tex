...
\mikkelin{The last part about dynamics is not part of the original article, should we expand on it?}
...
\mikkelin{Okay. Which citation do you mean by ``the later paper?''}
...
\mikael{Synes det er fint, måske bare noget mere hspace?}
...
\mikael{En meget lang beskrivelse af artiklen, men det er selvfølgelig svært at vide hvad det præcist skal bruges til endnu.}
