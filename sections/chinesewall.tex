...
\mikkel{\issue{52} Brug figurer til at illustrere hvorfor det er en ``mur''}
...
\mikkel{\issue{53} Omdan eksemplet til at være indeholdt i figuren \ref{china:hierarchy}, tilpas beskrivelse}

\subsection{The Security Policy}
\mikkel{\issue{54} Use the concrete examples from above instead of ABC for the various classes/companies}
