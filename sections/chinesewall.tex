...
When an analyst chooses to work with Shell there is therefore placed a conceptual wall around the other company in the same conflict of interest class as depicted in \cref{chinese:choice1}.
...
This can be seen in \cref{chinese:choice2}.
\end{example}
