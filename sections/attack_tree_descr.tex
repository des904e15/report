...
\Cref{contextual:sm_model} has been used as a basis and all the possible attacks have been marked with an arrow.
...
\stefan{Skal vi stadig have dette afsnit, når vi ikke bruger værdier?}
