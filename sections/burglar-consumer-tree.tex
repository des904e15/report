%!TEX root = ../master.tex
\section{Burglar attacking the consumer}
...
\begin{figure}
\center
\includegraphics[width=\textwidth, angle=90]{graphviz/burglarClient.pdf}
...
\subsubsection{Compromising the smart meter}\label{compromiseSM}
...
\begin{description}
	...
	Password cracking will be discussed in \stefan{ref}
\end{description}
...
\begin{figure}
\center
\includegraphics[width=0.75\textwidth]{graphviz/CompromiseSM.pdf}
\caption{Subtree for compromising the smart meter.}
\label{attacktree:compromiseSM}
\end{figure}


\subsubsection{Compromising the client}
...
\begin{figure}
\center
\includegraphics[width=0.75\textwidth]{graphviz/CompromiseClient.pdf}
