...
\stefan{nok om DPA?}
\mikael{Would it be a good idea to add some discussion to all/most of these sections. Just something about why it is important in relations to smart meters. Here, for instance, something about physical access to the meter where the consumer can set up a multimeter or whatever.}
...
Another way is to try all passwords or to just reset the password.\cite{florencio2007large}\cite{bishop1995improving}\cite{dell2010password}
