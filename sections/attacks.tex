...
\stefan{nok om DPA?}
\mikkelin{Jeg synes ikke vi behøver mere om selve metoden - men måske lidt kontekst, som Mikaels forslag nedenfor.}
...
\mikael{Should we reflect or discuss a bit as well? E.g. how this effectively could circumvent even the most advanced software security if you just go ahead and publicly display your password. \#97}
