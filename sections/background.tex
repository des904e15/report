...
\begin{itemize}
	...
	\item use of smart appliances/home automation. \stefan{mangler måske en forklaring af hvad vi mener med smart appliance}
\end{itemize}
...
\end{figure}
\footnotetext{Figure Source:\\\url{https://www.telekom.com/medien/bild-ton-und-infografiken/infografiken/155030}}
...
\mikkel{I uncommented the listing below to make the subject of the subsection clearer.}
\begin{itemize}
...
\mikkelin{Me too.
I think it depends on whether we want to focus on a specific model.
Maybe we should revisit this when the focus of the project is more clear?}
...
\mikkel{The last point here seems to be taken out of thin air.
...
\mikkel{Couldn't it be that we can use the smart meter to detect tampering?
I don't think we can say that no attacks are removed.}
...
\mikkel{A reminder to fix this last sentence when we can reference something}
