...
\paragraph{Privacy}
% Smart meters will lead to higher granularity power consumption measurements (now: only on-site reporting)
% Higher granularity can be used commercially in several ways: offer tailored pricing (thus limiting competition), sell to electronics vendors, if lost can compromise residents/similar)
% Who owns/can use the data?
