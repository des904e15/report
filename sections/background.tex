...
A smart grid has several advantages over the old grid \cite{smartgrid_gov, directive_2009_72_EC}.
...
\end{itemize}
\stefan{bør vi følge op på denne liste?}
...
\end{itemize}
\stefan{disse spørgsmål kan muligvis bindes bedre sammen med resten af kapitlet/rapporten}
