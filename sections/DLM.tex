...
Given the acts-for relation, $\succeq$, and \principals{} $Amy$ and $Bob$, $Amy \succeq Bob$ means that Amy \textit{acts for} Bob.
...
Acts-for relations are reflexive and transitive, so that hierarchies can be formed.
