...
When a value enters the sytem through an input channel, the value gets the label of the input channel.
If a value is written to an output channel it can only be done if the label of the output channel is more or as restrictive as the label of the value.
\bruno{Example?}
