...
The owner is implicitly allowed to read his own data. \stefan{som jeg læser det er dette ikke korrekt, en owener kan ikke nødvendigvis læse sin egen data, fx {o1: r1,r2 ; o2 : o2,r1}, kan læses af o2 og r1}
If we want a \principal{} $p$ that should not allow any readers we use the following syntax: $p: <space> $\bruno{Synes det var mere klart end $p: \ $.}.
