...
The acts for relation, $\succeq$, can be used to model groups and roles.
To model two \principals{}, Amy and Bob, that act for a group of programmers: $Amy \succeq programmers$ and $Bob \succeq programmers$.
Or if Amy has different roles: $Amy \succeq Amy\_programmer$ and $Amy \succeq Amy\_admin$.
