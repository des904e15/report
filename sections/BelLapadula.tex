...
\mikkelin{\issue{55} brug lattice model til at visualisere}
...
\mikael{\#56 Skriv beskrivelse af security labels? Det med classification/clearance og category(ies). (skal være i starten)}
