...
The *-property ensures that given a \principal{} and a set of objects, $o_1$, which he has write or append access to and a set of objects, $o_2$, which he has read or read/write access to, that $o_1$ is the super set of $o_2$ and $o_1$ must exceed or equal $o_2$.
