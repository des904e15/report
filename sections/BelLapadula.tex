...
\begin{definition}
\mikkelin{Skal vi have title på vores definitioner?}
...
\mikkelin{This representation of an access matrix seems to differ from the previous one.
Or maybe it's too loosely defined.}
...
\begin{definition}
\mikkelin{Unsure what this definition is actually defining. It seems that it might be split in two definitions?}
